...
credentials = ee.ServiceAccountCredentials(service_account, 'leafy-rope-354103-f81b0028a3a9.json')# uno el .json que descargue de google cloud
...
def registrarse():
 ...
 # redireciono con el boton a la pgina html con la funion registrado, con el metodo de post para envair
