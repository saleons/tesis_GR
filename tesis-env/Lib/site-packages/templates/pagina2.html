...
<head>
  ...
  <!-- importo estilo CSS desde el archivo styles/estilos.css-->
...
<body>
  <div class ="container">
    ...
    <div class ="row justify-content-center pt-5 mt-5 mr-1">
      <div class ="col-md-4 col-sm-6 col-xl-4 col-lg-4 formulario">
        <form action="">
          ...
          <div class ="form-group text-center">
            <span><a href='/registrarse' class = "olvide1">REGISTRARSE</a><span>
          </div>
        </form>   
      </div>
    </div>
