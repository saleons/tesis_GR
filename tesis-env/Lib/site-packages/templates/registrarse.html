       ...
       <div class="row no-gutters bg-dark">
           <div class="col-xl-5 col-lg-12 register-bg">
            <div class="position-absolute testiomonial p-4">
                <h3 class="font-weight-bold text-light">UNIDOS SOMOS MAS.</h3>
                    ...
                    <form action="/registrado" method="POST">
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                ...
                                <!-- capturo la informacion del nombre con (name="Nombre")-->
                                <label class="font-weight-bold">Nombre <span class="text-danger">*</span></label>
                                <input type="text" name="Nombre" class="form-control" placeholder="Tu nombre" id="x1">
                            </div>
                            <div class="form-group col-md-6">
                                <!-- capturo la informacion del nombre con (name="Nombre")-->
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="password" class="form-control" placeholder="Ingresa una contraseña">
                        </div>
                        ...
                        <div class ="form-group text-center">
                            <button>Registrar<class = "olvide1" /button>  
                        </div>    
