import folium
def hacer_mapa(coordenada_centrar):
    ...
    # agrego html
    html=("<h1 class='text-center'> SISTEMA DE GESTION DE RIESGOS</h1>"
          "<h2 class='text-center'> vereda granizal</h2>"
          "<div class='btn-group'>"
          "<a href='/pagina2'class='btn btn-primary active' aria-current='page'>Iniciar session</a>"
